...
- <nomComplet1>Gabriel Galipeau</nomComplet1>
- <courriel1>gabriel.galipeau@ens.etsmtl.ca</courriel1>
- <codeMoodle1>AT32640</codeMoodle1>
- <githubAccount1>xGabou</githubAccount1>
...
![Diagramme de séquence système, redémarrer](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://raw.githubusercontent.com/profcfuhrmanets/log210-jeu-de-des-node-express-ts/master/docs/modeles/dss-redemarrerJeu.puml)
...
- Toutes les instances j de Joueur ont été supprimées
- Aucun jeu n'est en cours

**RDCU**

![Diagramme de séquence, redémarrerJeu](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://raw.githubusercontent.com/profcfuhrmanets/log210-jeu-de-des-node-express-ts/master/docs/modeles/rdcu-redemarrerJeu.puml)
